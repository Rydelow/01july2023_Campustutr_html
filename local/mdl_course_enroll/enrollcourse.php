...
<body><p>Hi <b>".$fname."</b>,</p>
    ...
    <p> Thank you for registration. To access your course, go to http://campustutr.com/login/index.php Your user name is <b>$user_name</b> , and your password is <b>$pwd</b> </p>
...
<table style='background-color: rgb(237 235 235);' cellpadding='15'>
 ...
 <a  href='http://campustutr.com/login/index.php' style='padding: 10px 50px;
 ...
 font-weight: bold;'> MY LEARNING ACCOUNT</a>
    ...
    <p>campustutr.com </p></body></html>";

         $fromUser = "notification@campustutr.com";
        $subject = 'Welcome to Campustutr Learning! Registration confirmation';
...
<body><p>Hi <b>".$fname."</b>,</p>
   <p>$fname  $lname  has registered LMS Portal. </p>
    <p> Thank you for enrolling for our course. To access your course, go to https://campustutr.com/login/index.php. </p>
    <p><b>Your Course:</b> ".$allcourse_name."</p>
    <p>Thanks, </p>
    ...
    <p>campustutr.com </p></body></html>";
         ...
         $fromUser = "notification@campustutr.com";
        $subject = 'Campustutr Learning! Registration confirmation';
        $emailuser = new stdClass();
        $emailuser->email = $email;
        $emailuser->firstname = $fname;
        $emailuser->lastname= $lname;
