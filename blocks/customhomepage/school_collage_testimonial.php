...
include('form_school_collage_testimonial.php');
...
$PAGE->navbar->add(('School & Collage Testimonial Content'), new moodle_url('/blocks/customhomepage/school_collage_testimonial.php'));
$PAGE->set_url('/blocks/customhomepage/school_collage_testimonial.php');
echo $OUTPUT->header();
...
$topbardata = $DB->get_record('student_collage_testimonial',array('id'=>$id));
...
$setdata->address=$topbardata->address;
...
$topbar_slider->name=$fromform->name;
	$topbar_slider->address=$fromform->address;
	$topbar_slider->timemodified=time();
	$DB->insert_record('student_collage_testimonial', $topbar_slider,true);
	...
	$topbar_slider->address=$fromform->address;
	$topbar_slider->timemodified=time();
	$DB->update_record('student_collage_testimonial', $topbar_slider,true);
	
}


redirect($CFG->wwwroot."/blocks/customhomepage/edit_school_collage.php?sucessfully=update");
