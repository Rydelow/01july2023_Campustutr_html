...
include('form_home_testimonial.php');
...
$PAGE->navbar->add(('Home Testimonial Content'), new moodle_url('/blocks/customhomepage/tutors_testimonial.php'));
...
$topbardata = $DB->get_record('home_testimonial',array('id'=>$id));
...
$topbar_slider->name=$fromform->name;
	...
	$DB->insert_record('home_testimonial', $topbar_slider,true);
	...
	$topbar_slider->address=$fromform->address;
	$topbar_slider->timemodified=time();
	$DB->update_record('home_testimonial', $topbar_slider,true);
	
}


redirect($CFG->wwwroot."/blocks/customhomepage/home_testimonials.php?sucessfully=update");
