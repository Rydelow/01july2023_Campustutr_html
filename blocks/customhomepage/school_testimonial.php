...
include('form_school_school_testimonial.php');
...
$PAGE->set_title('School Testimonial Content');
$PAGE->set_heading('School Testimonial Content');
$loginsite = 'Custom Home Page';
//$PAGE->navbar->add($loginsite);
$PAGE->navbar->add(('School Testimonial Content'), new moodle_url('/blocks/customhomepage/school_testimonial.php'));
$PAGE->set_url('/blocks/customhomepage/school_testimonial.php');
echo $OUTPUT->header();
...
$topbardata = $DB->get_record('student_student_testimonial',array('id'=>$id));
...
$topbar_slider->name=$fromform->name;
	...
	$DB->insert_record('student_student_testimonial', $topbar_slider,true);
	...
	$topbar_slider->address=$fromform->address;
	$topbar_slider->timemodified=time();
	$DB->update_record('student_student_testimonial', $topbar_slider,true);
	
}


redirect($CFG->wwwroot."/blocks/customhomepage/edit_students.php?sucessfully=update");
