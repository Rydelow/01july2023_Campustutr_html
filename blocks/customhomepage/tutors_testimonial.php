...
include('form_tutors_testimonial.php');
...
$PAGE->navbar->add(('Tutors Testimonial Content'), new moodle_url('/blocks/customhomepage/tutors_testimonial.php'));
$PAGE->set_url('/blocks/customhomepage/tutors_testimonial.php');
echo $OUTPUT->header();
...
$topbardata = $DB->get_record('student_testimonial',array('id'=>$id));
...
$topbar_slider->name=$fromform->name;
	...
	$DB->insert_record('student_testimonial', $topbar_slider,true);
	...
	$topbar_slider->address=$fromform->address;
	$topbar_slider->timemodified=time();
	$DB->update_record('student_testimonial', $topbar_slider,true);
	
}


redirect($CFG->wwwroot."/blocks/customhomepage/edit_tutors.php?sucessfully=update");
